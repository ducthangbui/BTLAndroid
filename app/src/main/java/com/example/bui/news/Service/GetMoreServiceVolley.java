...
public class GetMoreServiceVolley {
    ...
    public GetMoreServiceVolley(Context context, TextView textView, TextView textViewRecommend, TextView textViewRecommend2, TextView textViewRecommend3){
